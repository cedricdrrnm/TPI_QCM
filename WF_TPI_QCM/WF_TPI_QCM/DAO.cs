...
namespace WF_TPI_QCM
{
    class DAO
    {
        ...
        static public void InsertQCM(string nomQCM, int level)
        {
        ...
        static public void UpdateQCMByIdQCM(int idQCM, string nomQCM, int level)
        {
        ...
        static public void DeleteQCMByIdQCM(int idQCM)
        {
